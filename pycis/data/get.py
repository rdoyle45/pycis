import sys
sys.path.append('/pfs/work/g2rdoyl/CIS')
...
cal_lut_file = '/pfs/work/g2rdoyl/CIS/ssilburn/CIS_MATLAB_calibrations/LUT.xlsx'
cal_dir = '/pfs/work/g2rdoyl/CIS/ssilburn/CIS_MATLAB_calibrations'

try:
    # Load the ol' custom flow colour map
    cmd = np.loadtxt('/pfs/work/g2rdoyl/CIS/ssilburn/CIS/flow_cmap.txt')
